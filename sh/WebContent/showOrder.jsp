			...
			<div class="row">
			  <div class="col-md-12">
				 <div class="header-left">
					 <div class="logo">
						<a href="${ctx }/successLogin.jsp"><img src="${ctx }/images/logo.png" alt=""/></a>
					 </div>
					 <div class="menu">
     ...
     <div class="main">
      <div class="shop_top">
		...
		<c:if test="${list==null }">
			...
			<p class="cart">您的购物车中没有商品<br>点击<a href="productlist"> 这里</a> 继续购物</p>
		</c:if>
		<c:if test="${list!=null }">
			<table border="1" align="center">
				...
				<tr>
					<td>${orderid }</td>
					<td><img width="40" height="45" src="${ctx }/${l.getProduct().getListimg() }"/></td>
					<td>${l.getProduct().getName() }</td>
					<td>${l.getCount()}</td>
					<td>${l.getProduct().getPrice()}</td>
					<td><a href="/sh/Order/deleteOrder?orderId=${l.getProduct().getId()}">取消订单</a></td>
				</tr>
				</c:forEach>
				<tr>
					<td colspan="6">总价是：${count}</td>
				</tr>
			</table>
			<table>
				<form>
					<tr>
						<h2>收货人：</h2><input type="text" name="recive">
						
					</tr>
					<tr>
						<h2>联系电话：</h2><input type="text" name="phone">
					</tr>
					<tr>
						<h2>收货地址：</h2><input type="text" name="address">
					</tr>
				</form>
			</table>
		</c:if>
		<table>
					...
					<tr>
						...
						<tr>
							...
							<td width="140">
								<span class="subtotal">￥ ${li.getCount()*li.getProduct().getPrice()}</span>
							</td>
