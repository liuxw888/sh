	...
	<div class="header">
     ...
     <div class="main">
      <div class="shop_top">
		<div class="container">
		<c:if test="${rg==1}">
			<h4 class="title">注册失败</h4>
			<p class="cart">您已经注册或者邮箱格式不正确<br>点击<a href="${ctx }/login.jsp"> 这里</a>登录</p>
		</c:if>
		<c:if test="${rg==2 }">
			<h4 class="title">恭喜您，注册成功！</h4>
			<p class="cart">点击<a href="https://mail.qq.com/"> 这里</a>去邮箱激活</p><br>
			<p class="cart">点击<a href="${ctx }/login.jsp"> 这里</a>登录</p><br>
			<p class="cart">点击<a href="${ctx }/index.jsp"> 这里</a>返回主页</p>
		</c:if>
		<c:if test="${rg==3 }">
			<h4 class="title">注册失败</h4>
			<p class="cart">两次密码输入不正确或者邮箱格式不正确<br>点击<a href="${ctx }/register.jsp"> 这里</a>继续注册</p>
		</c:if>
	     </div>
	   </div>
	  </div>
