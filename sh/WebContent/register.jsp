						...
						<form action="/sh/registuser/regist" method="post"> 
								<div class="register-top-grid">
										...
										<div>
											...
											<input type="text" name="lastname" id="lastname" onblur="check1()"><span id="error6"></span><br/> 
										</div>
										<div>
											<span>名称<label>*</label></span>
											<input type="text" name="firstname" id="firstname" onblur="check2()"><span id="error4"></span><br/>
										</div>
										<div>
								...
								<div class="register-bottom-grid">
										...
										<div>
											...
											<input type="text" name="password" id="password" onblur="check3()"><span id="error5"></span><br/>
										</div>
										<div>
...
<script>
	function check1(){
		...
		if(lastname == null || lastname == ''){
			document.getElementById("error6").innerHTML = "用户名不能为空!";
			return false;
		}
}
	function check2(){
		...
		if(firstname == null||firstname == ''){
			document.getElementById("error4").innerHTML = "用户名不能为空!";
			return false;
		}
	}
	function check3(){
		...
		if(password == null || password == ''){
			document.getElementById("error5").innerHTML = "密码不能为空!";
			return false;
		}
	}
</script>
