					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 <div class="check_button"><a href="CountItem">去购物车结算</a></div>
		...
		<div class="container">
			...
			<span><h1>商品</h1></span>
				...
				<div class="col-md-3 shop_box"><a href="product?id=${p.id }">
					<img src="${ctx }/${p.listimg }" class="img-responsive" alt=""/>
					<span class="new-box">
					...
					<div class="shop_desc">
						...
						<p>${p.description } </p>
						<span class="reducedfrom">$2000.00</span>
						<span class="actual">${p.price}</span><br>
						<ul class="buttons">
							<li class="shop_btn"><a href="/sh/cart//toListProduct?productid=${p.id }">加入购物车</a></li>
							<li class="shop_btn"><a href="/sh/product/listProductDescription?productid=${p.id }">了解更多</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</a></div>
			...
			<div>
		 	<span><h1>热销商品</h1></span><br>
				<c:forEach items="${products1 }" var="p1">
				<div class="col-md-3 shop_box"><a href="product?id=${p1.id }">
					<img src="${ctx }/${p1.listimg }" class="img-responsive" alt=""/>
					<span class="new-box">
						<span class="new-label">热销商品</span>
					</span>
					<span class="sale-box">
						<span class="sale-label">促销</span>
					</span>
					<div class="shop_desc">
						<h3><a href="#">${p1.name }</a></h3>
						<p>${p1.description } </p>
						<span class="reducedfrom">$2000.00</span>
						<span class="actual">${p1.price}</span><br>
						<ul class="buttons">
							<li class="shop_btn"><a href="/sh/cart//toListProduct?productid=${p1.id }">加入购物车</a></li>
							<li class="shop_btn"><a href="/sh/product/listProductDescription?productid=${p1.id }">了解更多</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</a></div>
		 	...
		 	<div>
			 	<span><h1>最新商品</h1></span><br>
					<c:forEach items="${products2 }" var="p2">
					<div class="col-md-3 shop_box"><a href="product?id=${p2.id }">
						<img src="${ctx }/${p2.listimg }" class="img-responsive" alt=""/>
						<span class="new-box">
							<span class="new-label">热销商品</span>
						</span>
						<span class="sale-box">
						...
						<div class="shop_desc">
							<h3><a href="#">${p2.name }</a></h3>
							<p>${p2.description } </p>
							<span class="reducedfrom">$2000.00</span>
							<span class="actual">${p2.price}</span><br>
							<ul class="buttons">
								<li class="shop_btn"><a href="/sh/cart//toListProduct?productid=${p2.id }">加入购物车</a></li>
								<li class="shop_btn"><a href="/sh/product/listProductDescription?productid=${p2.id }">了解更多</a></li>
								<div class="clear"> </div>
						    </ul>
					    </div>
					</a></div>
