...
<script type="text/javascript">
     ...
     <!----details-product-slider--->
				<!-- Include the Etalage files -->
					<link rel="stylesheet" href="${ctx }/css/etalage.css">
					<script src="${ctx }/js/jquery.etalage.min.js"></script>
				<!-- Include the Etalage files -->
				<script>
				 ...
				 <div class="header-left">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="${ctx }/images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="product/listProduct2">商店</a></li>
      ...
      <div class="shop_top">
		<div class="container">
			<div class="row">
				<div class="col-md-9 single_left">
				   <div class="single_image">
					     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="${ctx }/images/3.jpg" />
									<img class="etalage_source_image" src="${ctx }/images/3.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/4.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/4.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/5.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/5.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/6.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/6.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/7.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/7.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/8.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/8.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="${ctx }/images/9.jpg" />
								<img class="etalage_source_image" src="${ctx }/images/9.jpg" />
							</li>
						</ul>
					    </div>
				        <!-- end product_slider -->
				        <div class="single_right">
							...
							<div class="btn_form">
							   <form action="/sh/Order/toListOrder?orderId=${pro.id}">
								 <input type="submit" value="立刻购买" title="">
							  </form>
							</div>
							<ul class="add-to-links">
    			              <li><img src="${ctx }/images/wish.png" alt=""><a href="#">添加到心愿列表</a></li>
    			            </ul>
				...
				<div class="col-md-3">
				<form action="/sh/cart/toListProduct" method="post">
				  <input name="id" type="hidden" value="${pro.id }" />
				  <div class="box-info-product">
					<p class="price2">$${pro.price }</p>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					<img src="${ctx }/images/s1.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="single.html">
						...
						<ul class="buttons">
							<li class="cart"><a href="/sh/cart/toListProduct?productid=${pro.id }">加入购物车</a></li>
							<li class="shop_btn"><a href="/sh/product/listProductDescription?productid=${pro.id }">了解更多</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
				<div class="col-md-4 product1">
					<img src="${ctx }/images/s2.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="single.html">
						</a><h3><a href="single.html"></a><a href="#">商品</a></h3>
						<p>商品描述 </p>
						<span class="reducedfrom">$66.00</span>
				...
				<div class="col-md-4">
					<img src="${ctx }/images/s3.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="single.html">
						</a><h3><a href="single.html"></a><a href="#">商品</a></h3>
						<p>商品描述 </p>
						<span class="reducedfrom">$66.00</span>
