...
<%@ page import="com.sh.entity.Cart,com.sh.entity.CartItem" %>
...
<!--start slider -->
<link rel="stylesheet" href="${ctx }/css/fwslider.css" media="all">
<script src="${ctx }/js/jquery-ui.min.js"></script>
<script src="${ctx }/js/fwslider.js"></script>
<!--end slider -->
					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 <div class="check_button"><a href="checkout.jsp">去购物车结算</a></div>
	...
	<!-- start slider -->
       <div id="fwslider">
         <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
               <img src="${ctx }/images/slider1.jpg" class="img-responsive" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
               <img src="${ctx }/images/slider2.jpg" class="img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">Run Over<br>Everything</h1>
                       	<div class="button"><a href="#">See Details</a></div>
	  ...
	  <div class="main">
		<div class="content-top">
			...
			<div class="close_but"><i class="close1"> </i></div>
				<ul id="flexiselDemo3">
				<li><img src="${ctx }/images/board1.jpg" /></li>
				<li><img src="${ctx }/images/board2.jpg" /></li>
				<li><img src="${ctx }/images/board3.jpg" /></li>
				<li><img src="${ctx }/images/board4.jpg" /></li>
				<li><img src="${ctx }/images/board5.jpg" /></li>
			</ul>
		<h3>滑雪板极限系列</h3>
			<script type="text/javascript">
		...
		<script type="text/javascript" src="${ctx }/js/jquery.flexisel.js"></script>
		</div>
	</div>
			...
			<div class="close_but"><i class="close1"> </i></div>
			  <div class="row">
				...
				<div class="col-md-3 top_box1">
					<div class="view view-ninth"><a href="single.html">
                    <img src="${ctx }/images/pic4.jpg" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>好玩</h2>
