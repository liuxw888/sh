      ...
      <div class="shop_top">
		...
		<c:if test="${list!=null }">
			<table border="1" align="center">
				...
				<tr>
					<td><img width="130" height="125" src="${ctx }/${l.getProduct().getListimg() }"/></td>
					<td>${l.getProduct().getName() }</td>
					<td>${l.getCount()}</td>
					<td>${l.getProduct().getPrice()}</td>
					<td><a href="/sh/Order/toListOrder?orderId=${l.getProduct().getId()}">加入订单</a></td>
					<td><a href="/sh/cart/deleteCart?productid=${l.getProduct().getId()}">取消此商品</a></td>
				</tr>
				</c:forEach>
				<tr>
